    ...
    if (this instanceof CleverTabs) {
        CleverTabs.prototype.resizePanelContainer = function () {
            if (pc.attr('id').indexOf('cleverTabsPanelContainer') === 0) {
                ...
                pc.css('height', Math.floor(height / self.height() * 100+1) + '%');
            }
        }
    }
};
...
CleverTabs.prototype.add = function (options) {
    ...
    .replace(/#\{label\}/g, function () {
        //如果Tab的Label大于7个字符，则强制使其为前7个字符加'...' 20
        if (options.label.length > 20) {
            return options.label.substring(0, 20) + '...';
        }
...
CleverTabs.prototype.setupContextMenu = function () {
    ...
    if (!self.options.contextMenu) {
        ...
        //+ '<li id="mnuCloseAll"><a href="#clearPre"><span class="ui-icon ui-icon-closethick" style="float: left; margin-right: 5px;"></span>关闭左边</a></li>'
        //+ '<li id="mnuCloseAll"><a href="#clearNext"><span class="ui-icon ui-icon-closethick" style="float: left; margin-right: 5px;"></span>关闭右边</a></li>'
